...
#include "utils.h"
#include "matrices.h"
// Header local que contém a função BuildTriangles()
#include "scene_builder.h"

// Declaração de várias funções utilizadas em main().
// void BuildTriangles(); // Foi movido para scene_builder.h // Constrói os triângulos que serão renderizados
...
void ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
    ...
    // Uma câmera look-at nunca pode estar exatamente "em cima" do ponto para a
